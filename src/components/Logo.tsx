  ...
  return (
    <div className={`flex flex-col items-center ${className}`}>
      <div className="relative flex flex-col items-center">
        {/* Ki Stylized - Reprodução fiel da imagem */}
        <div className="flex items-end italic select-none relative">
          {/* Letra K - Verde Limão Vibrante */}
          <span className={`${currentSize.ki} font-black text-[#b8ff00] -skew-x-[20deg] tracking-tighter z-20`}>
            K
          </span>
          ...
          <div className={`flex flex-col items-center ${currentSize.gap} z-10 relative`}>
            ...
            <div 
              className={`${currentSize.dot} bg-[#b8ff00] rounded-[100%] mb-1 -skew-x-[20deg] shadow-[0_0_15px_rgba(184,255,0,0.3)]`} 
              style={{ transform: 'rotate(-10deg) skewX(-20deg)' }}
            />
            
            {/* Corpo do 'i' com corte na diagonal superior esquerda */}
            <span 
        ...
        {showTagline && (
          <div className="mt-6 flex flex-col items-center w-full">
            {/* Linha com Batimento Cardíaco (EKG) */}
