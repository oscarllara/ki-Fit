  ...
  return (
    <header className="relative overflow-hidden bg-black pt-16 pb-24 px-6 rounded-b-[4rem] shadow-2xl mb-8 border-b border-primary/20">
      ...
      <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center text-center">
        <div className="flex items-center gap-2 bg-white/5 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 mb-8">
        ...
        <p className="text-slate-400 text-lg font-medium mt-6 max-w-md">
          Sua melhor versão começa aqui. Treine com inteligência, supere seus limites.
        </p>
      </div>
    </header>
  );
